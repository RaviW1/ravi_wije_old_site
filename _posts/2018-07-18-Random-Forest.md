...
The model requires the maximum temperature, percipitation, and minimum teperature of the previous day.
...
For tommorrow which is June 7th 2018 the model predicts a maximum temperature of 90 degrees fahrenheit.
